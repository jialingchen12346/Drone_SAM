...
data = dict(samples_per_gpu=1,
            ...
            test=dict(type='DELIVER_easy',pipeline=test_pipeline,  mod_dir=mod_dir_test, mod_suffix=mod_suffix, modalities_name=modalities_name, modalities_ch=modalities_ch))
