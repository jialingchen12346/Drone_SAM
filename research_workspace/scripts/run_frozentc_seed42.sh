...
mkdir -p /root/autodl-tmp/work_dirs/label_eff_r10_frozentc_e30_seed42_softw_agf_dref_prob
/root/miniconda3/envs/torch211/bin/python segmentation/train_label_efficient.py \
  ...
  --point-weight 0.2 \
  --unsup-weight 1.0 \
  --teacher-ckpt /root/autodl-tmp/work_dirs/r100_sup_mmsa_agf_dref_prob_crop800_ohem_stretch_unfreeze4_tpi_e30_seed42_epoch30.pth \
  --bf16 \
  --work-dir /root/autodl-tmp/work_dirs/label_eff_r10_frozentc_e30_seed42_softw_agf_dref_prob \
  2>&1 | tee /root/autodl-tmp/logs/label_eff_r10_frozentc_e30_seed42_softw_agf_dref_prob.log
