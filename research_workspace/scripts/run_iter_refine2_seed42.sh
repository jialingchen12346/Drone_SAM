...
mkdir -p /root/autodl-tmp/work_dirs/label_eff_r10_iter_refine2_e30_seed42_softw_agf_dref_prob
/root/miniconda3/envs/torch211/bin/python segmentation/train_label_efficient.py \
  ...
  --unsup-weight 1.0 \
  --bf16 \
  --work-dir /root/autodl-tmp/work_dirs/label_eff_r10_iter_refine2_e30_seed42_softw_agf_dref_prob \
  2>&1 | tee /root/autodl-tmp/logs/label_eff_r10_iter_refine2_e30_seed42_softw_agf_dref_prob.log
